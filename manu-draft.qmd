...
clearTakehome results: notable temp, salinity changes, some evidence of association with seagrass change. Of the limited evidence, effects of high temp, low salinity may just be additive, no support for interactions. This was shown by the FIM models and lack of significance for the "both" EPC model. Also, note that the PDEM data may have had low power, limited spatially (only west side of bay segment) and even shorter time period (supp fig, sal trends support this).
