...
GLMs for the "Both" model did not include a year category and the interaction of temp/sal in the first model was negligible (fig holds temp/sal at mean? for respective plots).
