...
ktres %>%
  ...
  iwalk(function(x, mo){
    ...
    fl <- paste0('figseda/skt_',sprintf('%02d', as.numeric(mo)), '.png')
...
ktres %>% 
  ...
  iwalk(function(x, loc){
    ...
    fl <- paste0('figseda/segsum_', loc, '.png')
...
png(here('figseda/tempgamex.png'), height = 3, width = 6, family = 'serif', units = 'in', res = 300)
print(p)
dev.off()
...
png(here('figseda/tempexceed.png'), height = 7, width = 6, family = 'serif', units = 'in', res = 300)
print(p)
dev.off()
...
png(here('figseda/tempcount.png'), height = 7, width = 7, family = 'serif', units = 'in', res = 300)
print(p)
dev.off()
...
png(here('figseda/saligamex.png'), height = 3, width = 6, family = 'serif', units = 'in', res = 300)
print(p)
dev.off()
...
png(here('figseda/saliexceed.png'), height = 7, width = 6, family = 'serif', units = 'in', res = 300)
print(p)
dev.off()
...
png(here('figseda/salicount.png'), height = 7, width = 7, family = 'serif', units = 'in', res = 300)
print(p)
dev.off()