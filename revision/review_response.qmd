...
*Line 669: “Ongoing work in OTB using continuous data loggers in shallow areas where seagrass has been gained or lost will provide insights into short-term diurnal changes as potential acute temperature stress (see https://tbep-tech.github.io/otb-temp/tempeval).”*
...
*Response: Line 120 was revised to describe that the upper bay segments are more shallow and receive a majority of hydrologic inflow. The previous statement was inaccurate. Also, please see the addition of Figure 2c that shows the long-term improvement in the light environment over time. Of particular note is that all bay segments are currently below the threshold supportive for seagrass growth.*
