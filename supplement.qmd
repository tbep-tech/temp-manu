...
![Water temperature and salinity trends from 2004 to 2022 for stations from the Pinellas County Department of Environmental Management in Old Tampa Bay. Points show the average (95% confidence interval) across all stations and sampling months for each year in each bay segment.](figs/supppincotrnds.png){#fig-supppincotrnds}
